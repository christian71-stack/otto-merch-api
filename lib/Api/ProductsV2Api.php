...
class ProductsV2Api
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV2GetProductVariationPriceRequest($sku)
    {
        // verify the required parameter 'sku' is set
        if ($sku === null || (is_array($sku) && count($sku) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV2GetProductVariationPricesRequest($sku = null, $product_reference = null, $category = null, $brand = null, $page = null, $limit = null)
    {
    ...
    {
        list($response) = $this->productsV2UpdateProductVariationPricesWithHttpInfo($body, $x_request_timestamp);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV2UpdateProductVariationPricesAsync($body = null, $x_request_timestamp = null)
    {
        return $this->productsV2UpdateProductVariationPricesAsyncWithHttpInfo($body, $x_request_timestamp)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV2UpdateProductVariationPricesRequest($body = null, $x_request_timestamp = null)
    {
