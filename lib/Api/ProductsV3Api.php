...
class ProductsV3Api
{
     ...
     *
     * @param  \\cbdesk\otto\Client\Model\ProductVariationProductsV3[] $body body (optional)
     ...
     * @return \cbdesk\otto\Client\Model\ProductProcessProgressProductsV3
     */
    public function productsV3CreateOrUpdateProductVariations($body = null, $x_request_timestamp = null)
    {
        list($response) = $this->productsV3CreateOrUpdateProductVariationsWithHttpInfo($body, $x_request_timestamp);
        return $response;
    }
     ...
     * Create or update product variations
     *
     * @param  \\cbdesk\otto\Client\Model\ProductVariationProductsV3[] $body (optional)
     * @param  string $x_request_timestamp Holds the optional client side update request timestamp, in ISO DateTime format (optional)
     *
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\ProductProcessProgressProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3CreateOrUpdateProductVariationsWithHttpInfo($body = null, $x_request_timestamp = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductProcessProgressProductsV3';
        $request = $this->productsV3CreateOrUpdateProductVariationsRequest($body, $x_request_timestamp);
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\otto\Client\Model\ProductProcessProgressProductsV3',
     ...
     */
    public function productsV3CreateOrUpdateProductVariationsAsync($body = null, $x_request_timestamp = null)
    {
        return $this->productsV3CreateOrUpdateProductVariationsAsyncWithHttpInfo($body, $x_request_timestamp)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3CreateOrUpdateProductVariationsAsyncWithHttpInfo($body = null, $x_request_timestamp = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductProcessProgressProductsV3';
        $request = $this->productsV3CreateOrUpdateProductVariationsRequest($body, $x_request_timestamp);
     ...
     */
    protected function productsV3CreateOrUpdateProductVariationsRequest($body = null, $x_request_timestamp = null)
    {
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\otto\Client\Model\ProductProcessResultProductsV3
     */
    public function productsV3FailedByProcessId($process_uuid)
    {
        list($response) = $this->productsV3FailedByProcessIdWithHttpInfo($process_uuid);
        return $response;
    }
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\ProductProcessResultProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3FailedByProcessIdWithHttpInfo($process_uuid)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductProcessResultProductsV3';
        $request = $this->productsV3FailedByProcessIdRequest($process_uuid);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\otto\Client\Model\ProductProcessResultProductsV3',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3FailedByProcessIdAsync($process_uuid)
    {
        return $this->productsV3FailedByProcessIdAsyncWithHttpInfo($process_uuid)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3FailedByProcessIdAsyncWithHttpInfo($process_uuid)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductProcessResultProductsV3';
        $request = $this->productsV3FailedByProcessIdRequest($process_uuid);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3FailedByProcessIdRequest($process_uuid)
    {
        // verify the required parameter 'process_uuid' is set
        if ($process_uuid === null || (is_array($process_uuid) && count($process_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $process_uuid when calling productsV3FailedByProcessId'
            );
        }
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\otto\Client\Model\ActiveStatusListResponseProductsV3
     */
    public function productsV3GetActiveStatus($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
        list($response) = $this->productsV3GetActiveStatusWithHttpInfo($sku, $product_reference, $category, $brand_id, $page, $limit);
        return $response;
    }
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\ActiveStatusListResponseProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3GetActiveStatusWithHttpInfo($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ActiveStatusListResponseProductsV3';
        $request = $this->productsV3GetActiveStatusRequest($sku, $product_reference, $category, $brand_id, $page, $limit);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\otto\Client\Model\ActiveStatusListResponseProductsV3',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetActiveStatusAsync($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
        return $this->productsV3GetActiveStatusAsyncWithHttpInfo($sku, $product_reference, $category, $brand_id, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetActiveStatusAsyncWithHttpInfo($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ActiveStatusListResponseProductsV3';
        $request = $this->productsV3GetActiveStatusRequest($sku, $product_reference, $category, $brand_id, $page, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3GetActiveStatusRequest($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\otto\Client\Model\BrandListResponseProductsV3
     */
    public function productsV3GetBrands($if_match = null, $if_none_match = null, $if_modified_since = null, $if_unmodified_since = null, $page = null, $limit = null)
    {
        list($response) = $this->productsV3GetBrandsWithHttpInfo($if_match, $if_none_match, $if_modified_since, $if_unmodified_since, $page, $limit);
        return $response;
    }
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\BrandListResponseProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3GetBrandsWithHttpInfo($if_match = null, $if_none_match = null, $if_modified_since = null, $if_unmodified_since = null, $page = null, $limit = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\BrandListResponseProductsV3';
        $request = $this->productsV3GetBrandsRequest($if_match, $if_none_match, $if_modified_since, $if_unmodified_since, $page, $limit);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\otto\Client\Model\BrandListResponseProductsV3',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetBrandsAsync($if_match = null, $if_none_match = null, $if_modified_since = null, $if_unmodified_since = null, $page = null, $limit = null)
    {
        return $this->productsV3GetBrandsAsyncWithHttpInfo($if_match, $if_none_match, $if_modified_since, $if_unmodified_since, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetBrandsAsyncWithHttpInfo($if_match = null, $if_none_match = null, $if_modified_since = null, $if_unmodified_since = null, $page = null, $limit = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\BrandListResponseProductsV3';
        $request = $this->productsV3GetBrandsRequest($if_match, $if_none_match, $if_modified_since, $if_unmodified_since, $page, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3GetBrandsRequest($if_match = null, $if_none_match = null, $if_modified_since = null, $if_unmodified_since = null, $page = null, $limit = null)
    {
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\otto\Client\Model\CategoryGroupsProductsV3
     */
    public function productsV3GetCategoryGroups($page = null, $limit = null, $category = null)
    {
        list($response) = $this->productsV3GetCategoryGroupsWithHttpInfo($page, $limit, $category);
        return $response;
    }
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\CategoryGroupsProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3GetCategoryGroupsWithHttpInfo($page = null, $limit = null, $category = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\CategoryGroupsProductsV3';
        $request = $this->productsV3GetCategoryGroupsRequest($page, $limit, $category);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\otto\Client\Model\CategoryGroupsProductsV3',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetCategoryGroupsAsync($page = null, $limit = null, $category = null)
    {
        return $this->productsV3GetCategoryGroupsAsyncWithHttpInfo($page, $limit, $category)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetCategoryGroupsAsyncWithHttpInfo($page = null, $limit = null, $category = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\CategoryGroupsProductsV3';
        $request = $this->productsV3GetCategoryGroupsRequest($page, $limit, $category);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3GetCategoryGroupsRequest($page = null, $limit = null, $category = null)
    {
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\otto\Client\Model\ContentChangesApiResultProductsV3
     */
    public function productsV3GetContentChanges($sku, $from_date = null, $page = null, $limit = null)
    {
        list($response) = $this->productsV3GetContentChangesWithHttpInfo($sku, $from_date, $page, $limit);
        return $response;
    }
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\ContentChangesApiResultProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3GetContentChangesWithHttpInfo($sku, $from_date = null, $page = null, $limit = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ContentChangesApiResultProductsV3';
        $request = $this->productsV3GetContentChangesRequest($sku, $from_date, $page, $limit);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\otto\Client\Model\ContentChangesApiResultProductsV3',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetContentChangesAsync($sku, $from_date = null, $page = null, $limit = null)
    {
        return $this->productsV3GetContentChangesAsyncWithHttpInfo($sku, $from_date, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetContentChangesAsyncWithHttpInfo($sku, $from_date = null, $page = null, $limit = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ContentChangesApiResultProductsV3';
        $request = $this->productsV3GetContentChangesRequest($sku, $from_date, $page, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3GetContentChangesRequest($sku, $from_date = null, $page = null, $limit = null)
    {
     ...
     * @return \cbdesk\otto\Client\Model\ContentChangesApiResultProductsV3
     */
    public function productsV3GetContentChanges2($sku = null, $from_date = null, $page = null, $limit = null)
    {
        list($response) = $this->productsV3GetContentChanges2WithHttpInfo($sku, $from_date, $page, $limit);
        return $response;
    }
     ...
     * @return array of \cbdesk\otto\Client\Model\ContentChangesApiResultProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3GetContentChanges2WithHttpInfo($sku = null, $from_date = null, $page = null, $limit = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ContentChangesApiResultProductsV3';
        $request = $this->productsV3GetContentChanges2Request($sku, $from_date, $page, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetContentChanges2Async($sku = null, $from_date = null, $page = null, $limit = null)
    {
        return $this->productsV3GetContentChanges2AsyncWithHttpInfo($sku, $from_date, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetContentChanges2AsyncWithHttpInfo($sku = null, $from_date = null, $page = null, $limit = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ContentChangesApiResultProductsV3';
        $request = $this->productsV3GetContentChanges2Request($sku, $from_date, $page, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3GetContentChanges2Request($sku = null, $from_date = null, $page = null, $limit = null)
    {
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\otto\Client\Model\MarketPlaceStatusProductsV3
     */
    public function productsV3GetMarketPlaceStatus($sku)
    {
        list($response) = $this->productsV3GetMarketPlaceStatusWithHttpInfo($sku);
        return $response;
    }
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\MarketPlaceStatusProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3GetMarketPlaceStatusWithHttpInfo($sku)
    {
        $returnType = '\cbdesk\otto\Client\Model\MarketPlaceStatusProductsV3';
        $request = $this->productsV3GetMarketPlaceStatusRequest($sku);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\otto\Client\Model\MarketPlaceStatusProductsV3',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetMarketPlaceStatusAsync($sku)
    {
        return $this->productsV3GetMarketPlaceStatusAsyncWithHttpInfo($sku)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetMarketPlaceStatusAsyncWithHttpInfo($sku)
    {
        $returnType = '\cbdesk\otto\Client\Model\MarketPlaceStatusProductsV3';
        $request = $this->productsV3GetMarketPlaceStatusRequest($sku);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3GetMarketPlaceStatusRequest($sku)
    {
        // verify the required parameter 'sku' is set
        if ($sku === null || (is_array($sku) && count($sku) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\otto\Client\Model\MarketPlaceStatusApiResultProductsV3
     */
    public function productsV3GetMarketPlaceStatusList($sku = null, $product_reference = null, $category = null, $brand_id = null, $from_date = null, $page = null, $limit = null, $market_place_status = null, $sort_order = null)
    {
        list($response) = $this->productsV3GetMarketPlaceStatusListWithHttpInfo($sku, $product_reference, $category, $brand_id, $from_date, $page, $limit, $market_place_status, $sort_order);
        return $response;
    }
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\MarketPlaceStatusApiResultProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3GetMarketPlaceStatusListWithHttpInfo($sku = null, $product_reference = null, $category = null, $brand_id = null, $from_date = null, $page = null, $limit = null, $market_place_status = null, $sort_order = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\MarketPlaceStatusApiResultProductsV3';
        $request = $this->productsV3GetMarketPlaceStatusListRequest($sku, $product_reference, $category, $brand_id, $from_date, $page, $limit, $market_place_status, $sort_order);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\otto\Client\Model\MarketPlaceStatusApiResultProductsV3',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetMarketPlaceStatusListAsync($sku = null, $product_reference = null, $category = null, $brand_id = null, $from_date = null, $page = null, $limit = null, $market_place_status = null, $sort_order = null)
    {
        return $this->productsV3GetMarketPlaceStatusListAsyncWithHttpInfo($sku, $product_reference, $category, $brand_id, $from_date, $page, $limit, $market_place_status, $sort_order)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetMarketPlaceStatusListAsyncWithHttpInfo($sku = null, $product_reference = null, $category = null, $brand_id = null, $from_date = null, $page = null, $limit = null, $market_place_status = null, $sort_order = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\MarketPlaceStatusApiResultProductsV3';
        $request = $this->productsV3GetMarketPlaceStatusListRequest($sku, $product_reference, $category, $brand_id, $from_date, $page, $limit, $market_place_status, $sort_order);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3GetMarketPlaceStatusListRequest($sku = null, $product_reference = null, $category = null, $brand_id = null, $from_date = null, $page = null, $limit = null, $market_place_status = null, $sort_order = null)
    {
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\otto\Client\Model\ProductVariationApiResultProductsV3
     */
    public function productsV3GetPartnerProducts($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
        list($response) = $this->productsV3GetPartnerProductsWithHttpInfo($sku, $product_reference, $category, $brand_id, $page, $limit);
        return $response;
    }
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\ProductVariationApiResultProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3GetPartnerProductsWithHttpInfo($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductVariationApiResultProductsV3';
        $request = $this->productsV3GetPartnerProductsRequest($sku, $product_reference, $category, $brand_id, $page, $limit);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\otto\Client\Model\ProductVariationApiResultProductsV3',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetPartnerProductsAsync($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
        return $this->productsV3GetPartnerProductsAsyncWithHttpInfo($sku, $product_reference, $category, $brand_id, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetPartnerProductsAsyncWithHttpInfo($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductVariationApiResultProductsV3';
        $request = $this->productsV3GetPartnerProductsRequest($sku, $product_reference, $category, $brand_id, $page, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3GetPartnerProductsRequest($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
     ...
     */
    public function productsV3GetProductVariation($sku)
    {
        list($response) = $this->productsV3GetProductVariationWithHttpInfo($sku);
        return $response;
    }
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\ProductVariationProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3GetProductVariationWithHttpInfo($sku)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductVariationProductsV3';
        $request = $this->productsV3GetProductVariationRequest($sku);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\otto\Client\Model\ProductVariationProductsV3',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetProductVariationAsync($sku)
    {
        return $this->productsV3GetProductVariationAsyncWithHttpInfo($sku)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetProductVariationAsyncWithHttpInfo($sku)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductVariationProductsV3';
        $request = $this->productsV3GetProductVariationRequest($sku);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3GetProductVariationRequest($sku)
    {
        // verify the required parameter 'sku' is set
        if ($sku === null || (is_array($sku) && count($sku) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\otto\Client\Model\SkuPricingProductsV3
     */
    public function productsV3GetProductVariationPrice($sku)
    {
        list($response) = $this->productsV3GetProductVariationPriceWithHttpInfo($sku);
        return $response;
    }
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\SkuPricingProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3GetProductVariationPriceWithHttpInfo($sku)
    {
        $returnType = '\cbdesk\otto\Client\Model\SkuPricingProductsV3';
        $request = $this->productsV3GetProductVariationPriceRequest($sku);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\otto\Client\Model\SkuPricingProductsV3',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetProductVariationPriceAsync($sku)
    {
        return $this->productsV3GetProductVariationPriceAsyncWithHttpInfo($sku)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetProductVariationPriceAsyncWithHttpInfo($sku)
    {
        $returnType = '\cbdesk\otto\Client\Model\SkuPricingProductsV3';
        $request = $this->productsV3GetProductVariationPriceRequest($sku);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3GetProductVariationPriceRequest($sku)
    {
        // verify the required parameter 'sku' is set
        if ($sku === null || (is_array($sku) && count($sku) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\otto\Client\Model\PriceApiResultProductsV3
     */
    public function productsV3GetProductVariationPrices($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
        list($response) = $this->productsV3GetProductVariationPricesWithHttpInfo($sku, $product_reference, $category, $brand_id, $page, $limit);
        return $response;
    }
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\PriceApiResultProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3GetProductVariationPricesWithHttpInfo($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\PriceApiResultProductsV3';
        $request = $this->productsV3GetProductVariationPricesRequest($sku, $product_reference, $category, $brand_id, $page, $limit);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\otto\Client\Model\PriceApiResultProductsV3',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetProductVariationPricesAsync($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
        return $this->productsV3GetProductVariationPricesAsyncWithHttpInfo($sku, $product_reference, $category, $brand_id, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetProductVariationPricesAsyncWithHttpInfo($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\PriceApiResultProductsV3';
        $request = $this->productsV3GetProductVariationPricesRequest($sku, $product_reference, $category, $brand_id, $page, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3GetProductVariationPricesRequest($sku = null, $product_reference = null, $category = null, $brand_id = null, $page = null, $limit = null)
    {
     ...
     */
    public function productsV3GetVariationActiveStatus($sku)
    {
        list($response) = $this->productsV3GetVariationActiveStatusWithHttpInfo($sku);
        return $response;
    }
     ...
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\ActiveStatusProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3GetVariationActiveStatusWithHttpInfo($sku)
    {
        $returnType = '\cbdesk\otto\Client\Model\ActiveStatusProductsV3';
        $request = $this->productsV3GetVariationActiveStatusRequest($sku);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbdesk\otto\Client\Model\ActiveStatusProductsV3',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetVariationActiveStatusAsync($sku)
    {
        return $this->productsV3GetVariationActiveStatusAsyncWithHttpInfo($sku)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetVariationActiveStatusAsyncWithHttpInfo($sku)
    {
        $returnType = '\cbdesk\otto\Client\Model\ActiveStatusProductsV3';
        $request = $this->productsV3GetVariationActiveStatusRequest($sku);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3GetVariationActiveStatusRequest($sku)
    {
        // verify the required parameter 'sku' is set
        if ($sku === null || (is_array($sku) && count($sku) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \cbdesk\otto\Client\Model\ProductProcessProgressProductsV3
     */
    public function productsV3ProgressByProcessId($process_uuid)
    {
        list($response) = $this->productsV3ProgressByProcessIdWithHttpInfo($process_uuid);
        return $response;
    }
     ...
     * @return array of \cbdesk\otto\Client\Model\ProductProcessProgressProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3ProgressByProcessIdWithHttpInfo($process_uuid)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductProcessProgressProductsV3';
        $request = $this->productsV3ProgressByProcessIdRequest($process_uuid);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3ProgressByProcessIdAsync($process_uuid)
    {
        return $this->productsV3ProgressByProcessIdAsyncWithHttpInfo($process_uuid)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3ProgressByProcessIdAsyncWithHttpInfo($process_uuid)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductProcessProgressProductsV3';
        $request = $this->productsV3ProgressByProcessIdRequest($process_uuid);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3ProgressByProcessIdRequest($process_uuid)
    {
        // verify the required parameter 'process_uuid' is set
        if ($process_uuid === null || (is_array($process_uuid) && count($process_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $process_uuid when calling productsV3ProgressByProcessId'
            );
        }
     ...
     * @return \cbdesk\otto\Client\Model\ProductProcessResultProductsV3
     */
    public function productsV3SucceededByProcessId($process_uuid)
    {
        list($response) = $this->productsV3SucceededByProcessIdWithHttpInfo($process_uuid);
        return $response;
    }
     ...
     * @return array of \cbdesk\otto\Client\Model\ProductProcessResultProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3SucceededByProcessIdWithHttpInfo($process_uuid)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductProcessResultProductsV3';
        $request = $this->productsV3SucceededByProcessIdRequest($process_uuid);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3SucceededByProcessIdAsync($process_uuid)
    {
        return $this->productsV3SucceededByProcessIdAsyncWithHttpInfo($process_uuid)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3SucceededByProcessIdAsyncWithHttpInfo($process_uuid)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductProcessResultProductsV3';
        $request = $this->productsV3SucceededByProcessIdRequest($process_uuid);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3SucceededByProcessIdRequest($process_uuid)
    {
        // verify the required parameter 'process_uuid' is set
        if ($process_uuid === null || (is_array($process_uuid) && count($process_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $process_uuid when calling productsV3SucceededByProcessId'
            );
        }
     ...
     * @return \cbdesk\otto\Client\Model\ProductProcessResultProductsV3
     */
    public function productsV3UnchangedByProcessId($process_uuid)
    {
        list($response) = $this->productsV3UnchangedByProcessIdWithHttpInfo($process_uuid);
        return $response;
    }
     ...
     * @return array of \cbdesk\otto\Client\Model\ProductProcessResultProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3UnchangedByProcessIdWithHttpInfo($process_uuid)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductProcessResultProductsV3';
        $request = $this->productsV3UnchangedByProcessIdRequest($process_uuid);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3UnchangedByProcessIdAsync($process_uuid)
    {
        return $this->productsV3UnchangedByProcessIdAsyncWithHttpInfo($process_uuid)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3UnchangedByProcessIdAsyncWithHttpInfo($process_uuid)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductProcessResultProductsV3';
        $request = $this->productsV3UnchangedByProcessIdRequest($process_uuid);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3UnchangedByProcessIdRequest($process_uuid)
    {
        // verify the required parameter 'process_uuid' is set
        if ($process_uuid === null || (is_array($process_uuid) && count($process_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $process_uuid when calling productsV3UnchangedByProcessId'
            );
        }
     ...
     *
     * @param  \\cbdesk\otto\Client\Model\ActiveStatusListRequestProductsV3 $body body (optional)
     * @param  string $x_request_timestamp Holds the optional client side update request timestamp, in ISO DateTime format (optional)
     *
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\otto\Client\Model\ProductProcessProgressProductsV3
     */
    public function productsV3UpdateActiveStatus($body = null, $x_request_timestamp = null)
    {
        list($response) = $this->productsV3UpdateActiveStatusWithHttpInfo($body, $x_request_timestamp);
        return $response;
    }
     ...
     * Update active status
     *
     * @param  \\cbdesk\otto\Client\Model\ActiveStatusListRequestProductsV3 $body (optional)
     * @param  string $x_request_timestamp Holds the optional client side update request timestamp, in ISO DateTime format (optional)
     *
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\ProductProcessProgressProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3UpdateActiveStatusWithHttpInfo($body = null, $x_request_timestamp = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductProcessProgressProductsV3';
        $request = $this->productsV3UpdateActiveStatusRequest($body, $x_request_timestamp);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3UpdateActiveStatusAsync($body = null, $x_request_timestamp = null)
    {
        return $this->productsV3UpdateActiveStatusAsyncWithHttpInfo($body, $x_request_timestamp)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3UpdateActiveStatusAsyncWithHttpInfo($body = null, $x_request_timestamp = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductProcessProgressProductsV3';
        $request = $this->productsV3UpdateActiveStatusRequest($body, $x_request_timestamp);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3UpdateActiveStatusRequest($body = null, $x_request_timestamp = null)
    {
     ...
     *
     * @param  \\cbdesk\otto\Client\Model\SkuPricingProductsV3[] $body body (optional)
     * @param  string $x_request_timestamp Holds the optional client side update request timestamp, in ISO DateTime format (optional)
     *
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cbdesk\otto\Client\Model\ProductProcessProgressProductsV3
     */
    public function productsV3UpdateProductVariationPrices($body = null, $x_request_timestamp = null)
    {
        list($response) = $this->productsV3UpdateProductVariationPricesWithHttpInfo($body, $x_request_timestamp);
        return $response;
    }
     ...
     * Update product variation prices
     *
     * @param  \\cbdesk\otto\Client\Model\SkuPricingProductsV3[] $body (optional)
     * @param  string $x_request_timestamp Holds the optional client side update request timestamp, in ISO DateTime format (optional)
     *
     * @throws \ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cbdesk\otto\Client\Model\ProductProcessProgressProductsV3, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsV3UpdateProductVariationPricesWithHttpInfo($body = null, $x_request_timestamp = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductProcessProgressProductsV3';
        $request = $this->productsV3UpdateProductVariationPricesRequest($body, $x_request_timestamp);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3UpdateProductVariationPricesAsync($body = null, $x_request_timestamp = null)
    {
        return $this->productsV3UpdateProductVariationPricesAsyncWithHttpInfo($body, $x_request_timestamp)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3UpdateProductVariationPricesAsyncWithHttpInfo($body = null, $x_request_timestamp = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ProductProcessProgressProductsV3';
        $request = $this->productsV3UpdateProductVariationPricesRequest($body, $x_request_timestamp);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function productsV3UpdateProductVariationPricesRequest($body = null, $x_request_timestamp = null)
    {
