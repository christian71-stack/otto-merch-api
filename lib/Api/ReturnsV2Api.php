...
class ReturnsV2Api
{
    ...
    {
        list($response) = $this->returnsV2GetPositionItemsForUsingGETV2WithHttpInfo($limit, $page, $status);
        return $response;
    }
     ...
     */
    public function returnsV2GetPositionItemsForUsingGETV2Async($limit = '10', $page = '1', $status = null)
    {
        return $this->returnsV2GetPositionItemsForUsingGETV2AsyncWithHttpInfo($limit, $page, $status)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function returnsV2GetPositionItemsForUsingGETV2Request($limit = '10', $page = '1', $status = null)
    {
     ...
     * @return object
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2($body)
    {
        list($response) = $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2WithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2WithHttpInfo($body)
    {
        $returnType = 'object';
        $request = $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Request($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Async($body)
    {
        return $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2AsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2AsyncWithHttpInfo($body)
    {
        $returnType = 'object';
        $request = $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Request($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Request($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'
            );
        }
     ...
     * @return object
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2($body)
    {
        list($response) = $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2WithHttpInfo($body);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2WithHttpInfo($body)
    {
        $returnType = 'object';
        $request = $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Request($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Async($body)
    {
        return $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2AsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2AsyncWithHttpInfo($body)
    {
        $returnType = 'object';
        $request = $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Request($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Request($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'
            );
        }
