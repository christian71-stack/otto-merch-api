...
class QuantitiesV2Api
{
    ...
    {
        list($response) = $this->quantitiesV2GetAvailableQuantitiesWithHttpInfo($limit, $page, $cursor);
        return $response;
    }
     ...
     */
    public function quantitiesV2GetAvailableQuantitiesAsync($limit = '200', $page = '0', $cursor = null)
    {
        return $this->quantitiesV2GetAvailableQuantitiesAsyncWithHttpInfo($limit, $page, $cursor)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function quantitiesV2GetAvailableQuantitiesRequest($limit = '200', $page = '0', $cursor = null)
    {
