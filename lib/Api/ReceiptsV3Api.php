...
class ReceiptsV3Api
{
     ...
     * @param  string[] $receipt_types Search for receipts filtered by multiple receipt types (optional)
     ...
     */
    public function receiptsV3GetReceiptsUsingGET5($limit = '128', $page = '1', $receipt_types = null, $from = null, $to = null, $sales_order_id = null)
    {
        list($response) = $this->receiptsV3GetReceiptsUsingGET5WithHttpInfo($limit, $page, $receipt_types, $from, $to, $sales_order_id);
        return $response;
    }
     ...
     */
    public function receiptsV3GetReceiptsUsingGET5WithHttpInfo($limit = '128', $page = '1', $receipt_types = null, $from = null, $to = null, $sales_order_id = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ReceiptsListReceiptsV3';
        $request = $this->receiptsV3GetReceiptsUsingGET5Request($limit, $page, $receipt_types, $from, $to, $sales_order_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiptsV3GetReceiptsUsingGET5Async($limit = '128', $page = '1', $receipt_types = null, $from = null, $to = null, $sales_order_id = null)
    {
        return $this->receiptsV3GetReceiptsUsingGET5AsyncWithHttpInfo($limit, $page, $receipt_types, $from, $to, $sales_order_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiptsV3GetReceiptsUsingGET5AsyncWithHttpInfo($limit = '128', $page = '1', $receipt_types = null, $from = null, $to = null, $sales_order_id = null)
    {
        $returnType = '\cbdesk\otto\Client\Model\ReceiptsListReceiptsV3';
        $request = $this->receiptsV3GetReceiptsUsingGET5Request($limit, $page, $receipt_types, $from, $to, $sales_order_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function receiptsV3GetReceiptsUsingGET5Request($limit = '128', $page = '1', $receipt_types = null, $from = null, $to = null, $sales_order_id = null)
    {
