 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CategoryGroupProductsV3 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CategoryGroup__Products-V3';
...
'additional_requirements' => 'getAdditionalRequirements'    ];
     ...
     * Gets attributes
     *
     * @return \cbdesk\otto\Client\Model\AttributeDefinitionProductsV3[]
     */
     ...
     * Sets attributes
     *
     * @param \cbdesk\otto\Client\Model\AttributeDefinitionProductsV3[] $attributes list of the market place attributes for the categories of this group.
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at creation date date of the category.
     *
     * @return $this
     */
     ...
     *
     * @return \cbdesk\otto\Client\Model\AdditionalRequirementProductsV3[]
     */
     ...
     *
     * @param \cbdesk\otto\Client\Model\AdditionalRequirementProductsV3[] $additional_requirements a list of general requirements for certain product attributes that apply to all categories in the category group
     *
     * @return $this
     */
