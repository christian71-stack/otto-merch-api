...
self::TAX_TYPE_INSURANCE,        ];
     ...
     * Sets tax_type
     *
     * @param string $tax_type The fields indicates what kind of tax the price object includes
     *
     * @return $this
     */
     ...
     * Sets tax_rate
     *
     * @param string $tax_rate Applied tax rate, if there is any. Currently the entry can only be a decimal numbers. In future it's maybe also possible to have an expression such as \"NON_TAXABLE\", so we decided for a representation as string
     *
     * @return $this
     */
     ...
     * Sets net
     *
     * @param AllOfPriceReceiptsV3Net $net Calculated net value
     *
     * @return $this
     */
     ...
     * Sets tax
     *
     * @param AllOfPriceReceiptsV3Tax $tax Calculated tax value
     *
     * @return $this
     */
