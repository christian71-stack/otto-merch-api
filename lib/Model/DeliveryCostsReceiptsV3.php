...
/**
 * DeliveryCostsReceiptsV3 Class Doc Comment
 *
 * @category Class
 * @description List of billed logistic costs, if exists for this receipt.  This list is only used in context of receiptType PURCHASE or REFUND. If there are no entries the lists is displayed as empty
 * @package  cbdesk\otto\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeliveryCostsReceiptsV3 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeliveryCosts__Receipts-V3';
...
'price_modifications' => 'getPriceModifications'    ];
     ...
     *
     * @param string $delivery_cost_type Type of delivery costs for the shipment of physical goods
     *
     * @return $this
     */
     ...
     *
     * @param \cbdesk\otto\Client\Model\PriceModificationReceiptsV3[] $price_modifications List of additional fees and reductions represented as price modifications.  If there are no price modifications, an empty list is displayed
     *
     * @return $this
     */
