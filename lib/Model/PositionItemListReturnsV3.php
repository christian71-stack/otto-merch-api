 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PositionItemListReturnsV3 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PositionItemList__Returns-V3';
    ...
    protected static $swaggerTypes = [
        'position_items' => '\cbdesk\otto\Client\Model\PositionItemReturnsV3[]',
        'links' => '\cbdesk\otto\Client\Model\LinkReturnsV3[]'
    ];
     ...
     * Sets position_items
     *
     * @param \cbdesk\otto\Client\Model\PositionItemReturnsV3[] $position_items The list of queried items.
     *
     * @return $this
     */
     ...
     * Sets links
     *
     * @param \cbdesk\otto\Client\Model\LinkReturnsV3[] $links Links related to the list. E.g. the link to the successive list used during paging.
     *
     * @return $this
     */
