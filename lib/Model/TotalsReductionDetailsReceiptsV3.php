 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TotalsReductionDetailsReceiptsV3 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TotalsReductionDetails__Receipts-V3';
     ...
     * Sets voucher_code
     *
     * @param string $voucher_code The code of voucher associated with the receipt (contains only last 4 digits of code)
     *
     * @return $this
     */
