 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LineItemReceiptsV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LineItem__Receipts-V2';
...
'partial_refund_history' => 'getPartialRefundHistory'    ];
     ...
     * Gets unit_price
     *
     * @return AllOfLineItemReceiptsV2UnitPrice
     */
     ...
     * Sets unit_price
     *
     * @param AllOfLineItemReceiptsV2UnitPrice $unit_price The original unit gross price for a single item of this position before discount. Always displayed positively.
     *
     * @return $this
     */
     ...
     * Gets price_to_pay
     *
     * @return AllOfLineItemReceiptsV2PriceToPay
     */
     ...
     * Sets price_to_pay
     *
     * @param AllOfLineItemReceiptsV2PriceToPay $price_to_pay The billed unit gross price for a single position item of this position after discount (if there is any). Always displayed positively.
     *
     * @return $this
     */
     ...
     * Gets total_discount
     *
     * @return AllOfLineItemReceiptsV2TotalDiscount
     */
     ...
     * Sets total_discount
     *
     * @param AllOfLineItemReceiptsV2TotalDiscount $total_discount The total amount of discount of this lineItem (= discount per item * qantity). Values are always positive.
     *
     * @return $this
     */
     ...
     * Gets total
     *
     * @return AllOfLineItemReceiptsV2Total
     */
     ...
     * Sets total
     *
     * @param AllOfLineItemReceiptsV2Total $total Total gross price of this position.In case of purchase receipts it's calculated out of unit price and quantity.In case of refund or partial refund receipts, it's the granted price.Always displayed positively.
     *
     * @return $this
     */
