...
/**
 * ItemPositionsReceiptsV3 Class Doc Comment
 *
 * @category Class
 * @description List of billed items, if exists.  This list is only used in context of receiptType PURCHASE or REFUND. If there are no entries the lists is displayed as empty
 * @package  cbdesk\otto\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ItemPositionsReceiptsV3 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ItemPositions__Receipts-V3';
...
'price_modifications' => 'getPriceModifications'    ];
     ...
     * Sets line_number
     *
     * @param int $line_number Number of line item in which the information is printed on the pdf document.  This information is not reliably provided for older receipts
     *
     * @return $this
     */
     ...
     * Sets sku
     *
     * @param string $sku Stock keeping unit of item. Unique item identifier on partner side.  This information is not reliably provided for older receipts
     *
     * @return $this
     */
     ...
     *
     * @param string[] $position_item_ids List of unique identifiers of specific instances of ordered items. A (salesOrder)PositionItem is the smallest unit of an item that can be ordered. If quantity of the specific LineItem object is bigger than one the list contains more than one entry
     *
     * @return $this
     */
     ...
     *
     * @param \cbdesk\otto\Client\Model\PriceModificationReceiptsV3[] $price_modifications List of additional fees and reductions represented as price modifications.  Currently we only know reductions. If there are no entries the lists is displayed as empty
     *
     * @return $this
     */
