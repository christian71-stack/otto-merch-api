...
self::RECEIPT_TYPE_PARTIAL_REFUND,        ];
     ...
     * Sets receipt_type
     *
     * @param string $receipt_type Categorisation that classifies the receipts according to the main characteristics
     *
     * @return $this
     */
     ...
     * Sets receipt_number
     *
     * @param string $receipt_number Human readable identifier of a receipt known by customer. Guaranteed to be unique per partner
     *
     * @return $this
     */
     ...
     * Sets creation_date
     *
     * @param \DateTime $creation_date Date when receipt is created by system
     *
     * @return $this
     */
     ...
     * Sets shipment_date
     *
     * @param \DateTime $shipment_date Date when physical items of this receipt were handed over to the carrier to be delivered to the customer (UTC in ISO-8601 format). Only available on receipts of receiptType PURCHASE.
     *
     * @return $this
     */
     ...
     *
     * @param string $linked_receipt_number Human-readable identifier of linked receipt. In case of receiptType PARTIAL_REFUND or REFUND it is the receiptINumber of purchase receipt.  ATTENTION: In previous version the information was called originalReceiptNumber
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $linked_creation_date Creation date of linked receipt (UTC in ISO-8601 format). Only available if there is a linked receipt.  ATTENTION: In previous version the information was called originalCreatedDate
     *
     * @return $this
     */
