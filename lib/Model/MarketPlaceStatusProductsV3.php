 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MarketPlaceStatusProductsV3 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MarketPlaceStatus__Products-V3';
...
self::STATUS_APPROVED,        ];
     ...
     * Sets errors
     *
     * @param \cbdesk\otto\Client\Model\MarketPlaceStatusErrorProductsV3[] $errors errors that occurred when processing the variation
     *
     * @return $this
     */
     ...
     * Sets information
     *
     * @param \cbdesk\otto\Client\Model\MarketPlaceStatusInformationProductsV3[] $information information for product optimization on the OTTO market place
     *
     * @return $this
     */
     ...
     * Sets links
     *
     * @param \cbdesk\otto\Client\Model\MarketPlaceStatusLinkProductsV3[] $links contains the link to the partner variation data and to the product in OTTO shop
     *
     * @return $this
     */
