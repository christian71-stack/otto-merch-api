 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AvailableQuantitySingleResponseDTOAvailabilityV1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AvailableQuantitySingleResponseDTO__Availability-V1';
     ...
     * Sets last_modified
     *
     * @param string $last_modified The last modified date and time of available quantity as a ISO8601 format (yyyy-MM-dd'T'HH:mm:ss.SSSX).
     *
     * @return $this
     */
