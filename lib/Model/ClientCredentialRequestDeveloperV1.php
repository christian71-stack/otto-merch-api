<?php
/**
 * ClientCredentialRequestDeveloperV1
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ClientCredentialRequestDeveloperV1 Class Doc Comment
 *
 * @category Class
 * @package  cbdesk\otto\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ClientCredentialRequestDeveloperV1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClientCredentialRequest__Developer-V1';
...
'scope' => 'getScope'    ];
     ...
     * Sets client_id
     *
     * @param string $client_id identifies the client uniquely
     *
     * @return $this
     */
     ...
     * Sets client_secret
     *
     * @param string $client_secret secret for the client
     *
     * @return $this
     */
     ...
     * Sets grant_type
     *
     * @param string $grant_type type of token request. Only supported value is client_credentials
     *
     * @return $this
     */
     ...
     * Sets scope
     *
     * @param string $scope list of scopes that the client wants to be included in the access token (space separated)
     *
     * @return $this
     */
