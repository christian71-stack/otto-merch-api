 ...
 *
 * @category Class
 * @description Line items for which settlement is made.  ATTENTION: In previous version this name was used for  itemPositions only. Now there is a substructure that cares about all billing object of a receipt
 * @package  cbdesk\otto\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LineItemsReceiptsV3 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'item_positions' => '\cbdesk\otto\Client\Model\ItemPositionsReceiptsV3[]',
'item_partial_refund_positions' => '\cbdesk\otto\Client\Model\ItemPartialRefundPositionsReceiptsV3[]',
'service_positions' => '\cbdesk\otto\Client\Model\ServicePositionReceiptsV3[]',
'delivery_costs' => '\cbdesk\otto\Client\Model\DeliveryCostsReceiptsV3[]'    ];
...
'delivery_costs' => 'getDeliveryCosts'    ];
     ...
     * Gets item_positions
     *
     * @return \cbdesk\otto\Client\Model\ItemPositionsReceiptsV3[]
     */
     ...
     * Sets item_positions
     *
     * @param \cbdesk\otto\Client\Model\ItemPositionsReceiptsV3[] $item_positions List of billed items, if exists.  This list is only used in context of receiptType PURCHASE or REFUND. If there are no entries the lists is displayed as empty
     *
     * @return $this
     */
     ...
     *
     * @return \cbdesk\otto\Client\Model\ItemPartialRefundPositionsReceiptsV3[]
     */
     ...
     *
     * @param \cbdesk\otto\Client\Model\ItemPartialRefundPositionsReceiptsV3[] $item_partial_refund_positions List of billed partial refunds of items.  This list is only used in context of receiptType PARTIAL_REFUND. If there are no entries the lists is displayed as empty
     *
     * @return $this
     */
     ...
     *
     * @param \cbdesk\otto\Client\Model\ServicePositionReceiptsV3[] $service_positions List of billed B2C services, if exists for this receipt.  This list is only used in context of receiptType PURCHASE or REFUND. If there are no entries the lists is displayed as empty
     *
     * @return $this
     */
     ...
     * Gets delivery_costs
     *
     * @return \cbdesk\otto\Client\Model\DeliveryCostsReceiptsV3[]
     */
     ...
     * Sets delivery_costs
     *
     * @param \cbdesk\otto\Client\Model\DeliveryCostsReceiptsV3[] $delivery_costs List of billed logistic costs, if exists for this receipt.  This list is only used in context of receiptType PURCHASE or REFUND. If there are no entries the lists is displayed as empty
     *
     * @return $this
     */
