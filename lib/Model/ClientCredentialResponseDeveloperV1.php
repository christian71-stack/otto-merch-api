<?php
/**
 * ClientCredentialResponseDeveloperV1
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ClientCredentialResponseDeveloperV1 Class Doc Comment
 *
 * @category Class
 * @package  cbdesk\otto\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ClientCredentialResponseDeveloperV1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClientCredentialResponse__Developer-V1';
...
'scope' => 'getScope'    ];
     ...
     * Sets expires_in
     *
     * @param float $expires_in identifies token expiry
     *
     * @return $this
     */
     ...
     * Sets scope
     *
     * @param string $scope scopes attached to the token
     *
     * @return $this
     */
