 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MultiparcelTrackingKeyShipmentsV1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MultiparcelTrackingKey__Shipments-V1';
    ...
    const CARRIER_RABEN_LOGISTIK = 'RABEN_LOGISTIK';
    const CARRIER_RHENUS = 'RHENUS';
    const CARRIER_REIMER = 'REIMER';
    const CARRIER_REITHMEIER = 'REITHMEIER';
    const CARRIER_SCHOCKEMOEHLE = 'SCHOCKEMOEHLE';
    const CARRIER_SCHMIDT_GEVELSBERG = 'SCHMIDT_GEVELSBERG';
