 ...
 *
 * @category Class
 * @description List of additional fees and reductions represented as price modifications.  If there are no price modifications, an empty list is displayed
 * @package  cbdesk\otto\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
...
self::PRICE_MODIFICATION_TYPE_DEFECT_COMPENSATION,        ];
     ...
     *
     * @param string $price_modification_type This type describes the special increases or decreases in detail and how to deal with it
     *
     * @return $this
     */
