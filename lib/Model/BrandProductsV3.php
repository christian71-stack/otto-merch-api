 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BrandProductsV3 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Brand__Products-V3';
...
'usable' => 'getUsable'    ];
     ...
     * Sets id
     *
     * @param string $id the id value of the brand which you have to use with your product data uploads!
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name the name of the brand as it is known on the OTTO marketplace. Use this name to find the brand of your products in the list of available brands, but don't use it in your product data - use only the id value of the brand!
     *
     * @return $this
     */
     ...
     * Sets logo
     *
     * @param string $logo If a brand logo image is existing, you can find the URL of it here.
     *
     * @return $this
     */
     ...
     * Sets usable
     *
     * @param bool $usable If this value if ``false`` you are not allowed to use this brand for products you like to sell on the OTTO marketplace. If the value is ``true`` you might use this brand.
     *
     * @return $this
     */
