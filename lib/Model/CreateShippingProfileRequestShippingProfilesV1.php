 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateShippingProfileRequestShippingProfilesV1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateShippingProfileRequest__ShippingProfiles-V1';
     ...
     *
     * @param string $shipping_profile_name ShippingProfileName allows the partner to assign a descriptive and unique name  for a shipping profile
     *
     * @return $this
     */
     ...
     * Sets working_days
     *
     * @param string[] $working_days WorkingDays describe the specific days of the week on which the partner is available to process orders
     *
     * @return $this
     */
     ...
     * Sets order_cutoff
     *
     * @param string $order_cutoff OrderCutoff specifies the time for orders to be placed, so the ProcessingTime starts within the same day. <br> This must be in half hour duration in (HH:MM) 24 hours format. The cut-off time must be specified in CET time.
     *
     * @return $this
     */
