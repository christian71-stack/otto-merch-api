 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductDescriptionProductsV3 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductDescription__Products-V3';
...
'attributes' => 'getAttributes'    ];
     ...
     * Sets attributes
     *
     * @param \cbdesk\otto\Client\Model\AttributeProductsV3[] $attributes Lists all the descriptive information about a product variant a partner can provide. Must be provided in the form of a key values pair. Will be validated against the AttributeDefinitions from Category endpoint provided by Otto market.
     *
     * @return $this
     */
