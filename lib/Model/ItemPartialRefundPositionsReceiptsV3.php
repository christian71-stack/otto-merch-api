...
/**
 * ItemPartialRefundPositionsReceiptsV3 Class Doc Comment
 *
 * @category Class
 * @description List of billed partial refunds of items.  This list is only used in context of receiptType PARTIAL_REFUND. If there are no entries the lists is displayed as empty
 * @package  cbdesk\otto\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ItemPartialRefundPositionsReceiptsV3 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ItemPartialRefundPositions__Receipts-V3';
...
'partial_refund_amount' => 'getPartialRefundAmount'    ];
     ...
     *
     * @param string[] $position_item_ids List of unique identifiers of specific instances of ordered items.  A (salesOrder)PositionItem is the smallest unit of an item that can be ordered
     *
     * @return $this
     */
