...
self::PAYMENT_METHOD_DIRECT_DEBIT,        ];
     ...
     *
     * @param string $payment_provider Payment Provider chosen for the order
     *
     * @return $this
     */
     ...
     * Sets payment_method
     *
     * @param string $payment_method Payment method chosen by the customer to pay for this order
     *
     * @return $this
     */
     ...
     *
     * @param int $installment_count For payment methods with installments, this attribute indicates how many installments the customer has chosen when placing the order.  Only available on receipts of receiptType PURCHASE. This information is not reliably provided for older receipts
     *
     * @return $this
     */
