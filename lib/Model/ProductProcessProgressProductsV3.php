 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductProcessProgressProductsV3 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductProcessProgress__Products-V3';
...
'unchanged' => 'int',
'ping_after' => '\DateTime',
'links' => '\cbdesk\otto\Client\Model\ProductProcessResultLinkProductsV3[]'    ];
...
self::STATE_DONE,        ];
     ...
     * Sets succeeded
     *
     * @param int $succeeded the number of successfully processed variations
     *
     * @return $this
     */
     ...
     * Sets failed
     *
     * @param int $failed the number of failed processed variations
     *
     * @return $this
     */
     ...
     * Sets unchanged
     *
     * @param int $unchanged the number of unchanged and not processed variations
     *
     * @return $this
     */
     ...
     * Sets links
     *
     * @param \cbdesk\otto\Client\Model\ProductProcessResultLinkProductsV3[] $links a list of links that can be used to access detailed information about the process result
     *
     * @return $this
     */
