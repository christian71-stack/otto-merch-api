...
self::SERVICE_TYPE_INSURANCE,        ];
     ...
     * Sets line_number
     *
     * @param int $line_number Number of line item in which the information is printed on the pdf document of the receipt.  This information is not reliably provided for older receipts
     *
     * @return $this
     */
     ...
     * Sets service_type
     *
     * @param string $service_type Categorization that classifies services according to their main characteristics. Services of the same type are often treated in the same way
     *
     * @return $this
     */
     ...
     *
     * @param string $expected_performance_period Vague performance date. As the exact date is not known when generating the receipt, this information gives an indication when the service is expected to be fulfilled
     *
     * @return $this
     */
     ...
     *
     * @param string[] $service_position_item_ids List of unique identifiers of specific instances of services. A servicePositionItem is the smallest unit of a service that can be ordered. If quantity of this obejct  is bigger than one the list contains more than one entry
     *
     * @return $this
     */
