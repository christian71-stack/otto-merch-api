...
'linked_product_receipt_number' => null    ];
...
'linked_product_receipt_number' => 'linkedProductReceiptNumber'    ];
...
'linked_product_receipt_number' => 'setLinkedProductReceiptNumber'    ];
...
'linked_product_receipt_number' => 'getLinkedProductReceiptNumber'    ];
...
self::SERVICE_TYPE_INSURANCE,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['linked_product_receipt_number'] = isset($data['linked_product_receipt_number']) ? $data['linked_product_receipt_number'] : null;
    }
    ...
    /**
     * Gets linked_product_receipt_number
     *
     * @return string
     */
    public function getLinkedProductReceiptNumber()
    {
        return $this->container['linked_product_receipt_number'];
    }

    /**
     * Sets linked_product_receipt_number
     *
     * @param string $linked_product_receipt_number Human-readable identifier refers to the purchase receipt the linked item was billed. Displayed only if item is billed with another receipt.
     *
     * @return $this
     */
    public function setLinkedProductReceiptNumber($linked_product_receipt_number)
    {
        $this->container['linked_product_receipt_number'] = $linked_product_receipt_number;
