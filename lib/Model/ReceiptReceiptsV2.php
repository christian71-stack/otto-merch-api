 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReceiptReceiptsV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Receipt__Receipts-V2';
...
self::PAYMENT_PROVIDER_OTTOPAYMENTS,        ];
     ...
     *
     * @param string $payment_provider Possible values can be \"OTTOPAYMENTS\" or \"PLAZA\", where \"PLAZA\" means it can be Computop for \"Kreditkarte\" or otherwise it is Ratepay.
     *
     * @return $this
     */
