 ...
 *
 * @category Class
 * @description Address of the recipient entered by the customer when placing the order. Recipient can be a person or a pickup point.
 * @package  cbdesk\otto\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddressReceiptsV3 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Address__Receipts-V3';
...
'country_code' => 'getCountryCode'    ];
     ...
     * Sets street
     *
     * @param string $street Street of address.  For sales orders were  placed before 23rd Sep. 2021 street and house number are both parts of this field
     *
     * @return $this
     */
     ...
     * Sets house_number
     *
     * @param string $house_number House number of  address  Available for sales orders placed after 23rd Sep. 2021. For older sales orders the house number is part of the field street and this field is not shown at all
     *
     * @return $this
     */
     ...
     * Sets addition
     *
     * @param string $addition Additional information of the address  Can be used to provide additional information of address
     *
     * @return $this
     */
