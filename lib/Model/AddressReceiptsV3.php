...
class AddressReceiptsV3 implements ModelInterface, ArrayAccess
{
     ...
     * Sets house_number
     *
     * @param string $house_number House number of  address</br>Available for sales orders placed after 23rd Sep. 2021. For older sales orders the house number is part of the field street and this field is not shown at all
     *
     * @return $this
     */
     ...
     * Sets addition
     *
     * @param string $addition Additional information of the address</br>Can be used to provide additional information of address
     *
     * @return $this
     */
