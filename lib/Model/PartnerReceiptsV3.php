...
'weee_registration_number' => 'getWeeeRegistrationNumber'    ];
     ...
     * Sets register_court
     *
     * @param string $register_court Court where the company is registered. Information exists if it's maintained in partner core data.  ATTENTION: In previous version the information was called districtCourt
     *
     * @return $this
     */
     ...
     *
     * @param string $commercial_register_number Commercial register number. Unique in context of register court. Information exists if it's maintained in partner core data.  ATTENTION: In previous version the information was called registerNumber
     *
     * @return $this
     */
     ...
     *
     * @param string $head_of_supervisory_board The partner's head of supervisory board. Information exists if it's maintained in partner core data
     *
     * @return $this
     */
     ...
     * Sets shop_name
     *
     * @param string $shop_name Alias name of partner. Information exists if it's maintained in partner core data
     *
     * @return $this
     */
     ...
     *
     * @param string $weee_registration_number WEEE registration number of partner. Information exists if it's maintained in partner core data
     *
     * @return $this
     */
