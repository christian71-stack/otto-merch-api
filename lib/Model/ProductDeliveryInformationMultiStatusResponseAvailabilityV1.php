 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductDeliveryInformationMultiStatusResponseAvailabilityV1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductDeliveryInformationMultiStatusResponse__Availability-V1';
     ...
     * Sets results
     *
     * @param \cbdesk\otto\Client\Model\ProductDeliveryInformationResponseDTOAvailabilityV1[] $results List of all the skus with its shipping profile id and processing time
     *
     * @return $this
     */
     ...
     * Sets errors
     *
     * @param \cbdesk\otto\Client\Model\ErrorDetailsForMultiStatusAvailabilityV1 $errors errors
     *
     * @return $this
     */
