 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AcceptedPositionItemReturnsV3 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AcceptedPositionItem__Returns-V3';
    ...
    const REASON_RETURN_RECEIVED = 'RETURN_RECEIVED';
    const REASON_STATUS_SENT_BY_ACCIDENT = 'STATUS_SENT_BY_ACCIDENT';
    const REASON_CANCEL_REQUEST_BY_CUSTOMER = 'CANCEL_REQUEST_BY_CUSTOMER';
    const REASON_REFUND_AFTER_AFFIDAVIT = 'REFUND_AFTER_AFFIDAVIT';
    const REASON_COMPLAINT = 'COMPLAINT';
    const REASON_SHIPMENT_LOST = 'SHIPMENT_LOST';
    const REASON_RETURN_LOST = 'RETURN_LOST';
