 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductProcessProgressProductsV4 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductProcessProgress__Products-V4';
     ...
     * Gets links
     *
     * @return \cbdesk\otto\Client\Model\ProductProcessResultLinkProductsV4[]
     */
     ...
     * Sets links
     *
     * @param \cbdesk\otto\Client\Model\ProductProcessResultLinkProductsV4[] $links a list of links that can be used to access detailed information about the process result
     *
     * @return $this
     */
