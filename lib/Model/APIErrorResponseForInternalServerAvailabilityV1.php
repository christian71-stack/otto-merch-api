 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class APIErrorResponseForInternalServerAvailabilityV1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'APIErrorResponseForInternalServer__Availability-V1';
     ...
     * Sets code
     *
     * @param float $code status code of response
     *
     * @return $this
     */
     ...
     * Sets detail
     *
     * @param string $detail type of error
     *
     * @return $this
     */
     ...
     * Sets logref
     *
     * @param string $logref attribute of the error
     *
     * @return $this
     */
