 ...
 *
 * @category Class
 * @description Additional information to an item directly related to the service.  Object exists only if the service was sold together with an item
 * @package  cbdesk\otto\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
...
'service_relations' => '\cbdesk\otto\Client\Model\ServiceRelationsReceiptsV3[]'    ];
...
'service_relations' => 'getServiceRelations'    ];
     ...
     *
     * @param string $item_partner_name Name of the partner who sold the linked item.   Displayed only if the partner is different from partner of the receipt
     *
     * @return $this
     */
     ...
     * Sets sku
     *
     * @param string $sku Stock keeping unit of the linked item. Unique item identifier on partner side
     *
     * @return $this
     */
     ...
     *
     * @return \cbdesk\otto\Client\Model\ServiceRelationsReceiptsV3[]
     */
     ...
     *
     * @param \cbdesk\otto\Client\Model\ServiceRelationsReceiptsV3[] $service_relations List of ServiceRelation objects.  Contains entries if services were sold  together with items otherwise list is empty
     *
     * @return $this
     */
