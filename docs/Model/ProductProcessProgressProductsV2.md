...
**links** | [**\cbdesk\otto\Client\Model\ProductProcessResultLinkProductsV2[]**](ProductProcessResultLinkProductsV2.md) | a list of links that can be used to access detailed information about the process result | [optional] 
